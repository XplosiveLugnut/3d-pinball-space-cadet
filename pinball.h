...
int grtext_draw_ttext_in_box(const char * lpString, int mode, int, COLORREF color, int, int); // idb
int sub_10038F8();
LONG sub_1003975();
LONG sub_100399D();
...
int high_score_get_score_position(long int a1, int a2);
int high_score_place_new_score_into(int, int, const char * lpString, int); // idb
char *scramble_number_string(int Val, char *DstBuf);
signed int high_score_read(int a1, int a2);
int high_score_write(const char * lpString, int); // idb
...
int partman_record_labeled(int, const char * lpString); // idb
int partman_field_labeled(int, const char * lpString, int); // idb
...
int splash_screen(int, const char * lpString2, const char *); // idb
signed int timer_init(int a1);
void timer_uninit();
int timer_set(float, int, int); // idb
signed int timer_check();
int timer_kill(int a1);
int make_path_name(char * lpFilename, const char * lpString2, DWORD nSize); // idb
...
int loader_query_handle(const char * lpString); // idb
...
void create(void *, unsigned int, int, void *(*)(void *)); // idb
void destroy(void *, unsigned int, int, void (*)(void *)); // idb
...
void AvgSample(WORD *a1, unsigned char *a2, int a3, int a4, int a5);
int RepSample(_BYTE *a1, unsigned char *a2, signed int a3, int a4, int a5);
...
int RemoveInvalidIniNameCharacters(const char * lpString); // idb
UINT ShowWaveOutDevices();
const char *GetOperatingSystemPrefix();
int ReadRegistryToGetMachineSpecificInfSection(int, char * lpString1, int); // idb
int ReadRegistryInt(HKEY hKey, const char * lpSubKey, int); // idb
...
const char * lpString2 = NULL; // idb
char * lpString1 = NULL; // idb
...
const char * high_score_dlg_hst; // idb
int high_score_dlg_enter_name; // weak
int high_score_position; // idb
const char * high_score_default_name; // idb
